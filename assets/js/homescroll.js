...
function scrollGuideHandler() {
    scrollIndicatorDelay = setTimeout(function() {
        $(".scroll-guide").removeClass("hidden")
    }, 3e3)
}
$(".scroll-guide").removeClass("hidden"), $("body").on("click", ".scroll-guide", function(e) {
    e.preventDefault();
...
$(document).ready(function() {
    $("body").on("click", "nav li", function() {
    ...
    }), $("body").on("click", 'header a[alt="home"]', function(e) {
        1 != $("body").attr("show-frame") && (e.preventDefault(), $("body").attr("show-frame", 1))
    }), mobileAndTabletcheck() || $("body").on("click", ".app-download-link", function(e) {
        ...
        if (!$(e.target).is(":input, [contenteditable]")) {
            ...
            37 === e.which && 1 < o || 38 === e.which && 1 < o ? (e.preventDefault(), $("body").attr("show-frame", o - 1)) : (o < t && 39 === e.which || o < t && 40 === e.which || o < t && 32 === e.which) && (e.preventDefault(), $("body").attr("show-frame", o + 1)), a()
        }
    }), mobileAndTabletcheck() || $("section").not(":first-of-type").css("transform", "translateY(175vh)"), setTimeout(function() {
        $("body").addClass("scroll-override"), $("section").attr("style", "")
    }, 1e3);
    var a = function() {
        var e = $("body").attr("show-frame") - 1;
        $("nav ul li").eq(e).addClass("do-animation"), setTimeout(function() {
